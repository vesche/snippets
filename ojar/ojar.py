...
help_text  = '''
ojar (Oh, Just Another REPL) - https://github.com/vesche/ojar

Welcome to ojar, a little toolkit for doing simple tasks. It uses runes (single
letters) as categories, actions (words with meaning) to define what you want to
do, and arguments (supplied data).
